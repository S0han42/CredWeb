...
body{background-image: url('Business-Transaction.jpg');
...
<main role="main" class="container">
  ...
  <div class="row">
	...
	<center><font size="15">WELCOME TO PAYMENT MANAGEMENT</font></center>
...
<br>
<button id="users" class="btn btn-info btn-lg btn-block">View All Users</button>
<button id="newt" class="btn btn-info btn-lg btn-block">New Transaction</button> 
<button id="transaction" class="btn btn-info btn-lg btn-block">View All Transactions</button>
